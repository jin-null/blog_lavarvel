...
<div id="header">
    <div id="innerHeader">
        ...
        <div class="blog-header">
            <div class="blog-title"><IMG SRC="/assets/images/logo.png"  style="border:1px solid gray" BORDER="0" ALT="" align="absmiddle"> <a href="http://www.whphp.com">WHPHP</a></div>
        ...
        <div id="innerContent">
            <div class="commentbox">
                <TABLE cellpadding=3 cellspacing=3 width="680px">
                    <TR>
                        <TD colspan="2"><div class="block-title"><H5><IMG SRC="/assets/images/modify.gif" WIDTH="20" HEIGHT="23" BORDER="0" ALT="" align="absmiddle"> 编辑日志</H5></div>
                        </TD>
                    </TR>
                    <TR>
                        <TD colspan="2">
                            <form METHOD=POST id="form1" action="/update">
                                ...
                                <TABLE cellpadding=3 cellspacing=3 width="100%" style="font-size:14px">
                                    ...
                                    <TR>
                                        ...
                                        <TD class="tLeft"><input TYPE="text" class="huge text" check='Require' warning="标题不能为空" NAME="title" value="{{$article->title}}"></TD>
                                    </TR>
                                    <TR>
                                        <TD class="tRight" >分类：</TD>
                                        <TD class="tLeft" ><input TYPE="text" class="medium readonly text"  readonly NAME="categoryName" value=""><input TYPE="hidden" class="medium bLeft" NAME="categoryId"  value=""> </TD>
                                    </TR>
                                    <TR>
                                        <TD class="tRight tTop" >日志：</TD>
                                        <TD class="tLeft"><textarea name="content" id="textContent" cols="45" rows="5">{{$article->content}}</textarea></TD>
                                    </TR>
