    ...
    <div id="innerHeader">
        ...
        <div class="blog-header">
            <div class="blog-title">
                <IMG SRC="/assets/images/logo.png"  style="border:1px solid gray" BORDER="0" ALT="" align="absmiddle"> <a href="http://www.whphp.com">WHPHP</a>
            </div>
        ...
        <div id="innerContent">
            ...
            <div class="commentbox">
                <table cellpadding=3 cellspacing=3 width="680px" >
                    <tr>
                        <td colspan="2"><div class="block-title"><H5><IMG SRC="/assets/images/modify.gif" WIDTH="20" HEIGHT="23" BORDER="0" ALT="" align="absmiddle"> 发表新的日志</H5></div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <form METHOD=POST id="form1" action="/store">
